...
export const projectData = [
  {
    ...
    description: "Online store application created with React. Fetches an API and displays products on the page for user. Added items are stored in the app context for later purchase.",
  ...
  },
  {
    ...
    description: "React application that utilizes an omdb API. User can filter by title and type. Details for movie or other media item then displayed at the click of a button.",
  ...
  },
  {
    ...
    description: "Javascript focused web application that will generate a random travel destination. Links to flight and hotel booking included for each corresponding destination.",
  ...
  },
  {
    ...
    description: "React application that allows users to perform a quick currency conversion. The app performs an API request that give the user the latest data.",
  ...
  },
  {
    ...
    description: "CSS documentation page where users can come to understand some of the CSS fundamentals. Navigation is organized by CSS topics.",
